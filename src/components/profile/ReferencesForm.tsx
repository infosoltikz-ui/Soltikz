import { Plus, Trash2, User, Building2, Phone, Mail } from 'lucide-react'
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="text-[18px] font-black text-slate-900 mb-1">References</h2>
          <p className="text-[13px] font-medium text-slate-500">Provide professional references who can vouch for your work.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  defaultValue="CTO at Tech Innovations Inc." 
                  className="w-full h-11 pl-10 pr-4 rounded-xl border border-slate-200 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary text-[14px] font-medium text-slate-900 transition-colors bg-white"
                />
              </div>
            </div>
