    ...
    <div className="grid grid-cols-5 gap-5 mb-6">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex items-center justify-between">
        <div>
          ...
          <div className="text-[11px] font-bold text-slate-400">Almost Perfect!</div>
        </div>
      ...
      <div className="bg-white rounded-2xl p-5 border border-yellow-200 shadow-sm relative overflow-hidden">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <div className="text-3xl font-black text-slate-900 leading-none mt-2">Premium</div>
          </div>
