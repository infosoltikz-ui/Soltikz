            ...
            {!generatedResume ? (
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {/* Upper Document Controls & Single-Line Download Bar */}
                  <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl px-4 py-2.5 h-[52px] flex items-center justify-between gap-3 shadow-2xs shrink-0 whitespace-nowrap overflow-x-auto scrollbar-none">
                    <div className="flex items-center gap-2.5 shrink-0 whitespace-nowrap">
                      <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse shrink-0" />
                      <span className="text-[13px] font-bold text-slate-900 dark:text-slate-100 whitespace-nowrap">
                        Ready to Download
                      </span>
                      <span className="px-2.5 py-0.5 rounded-full text-[11px] font-extrabold bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 border border-emerald-200/60 shrink-0 whitespace-nowrap">
                        90+ ATS Score
                      </span>
                      <span className="text-slate-300 dark:text-slate-700 text-[12px] hidden md:inline shrink-0">•</span>
                      <span className="text-[12px] font-semibold text-emerald-600 dark:text-emerald-400 whitespace-nowrap hidden md:inline shrink-0">
                    ...
                    <div className="flex items-center gap-2.5 shrink-0 whitespace-nowrap">
                      <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700 shrink-0">
                        ...
                        <button
                          ...
                          className="px-2 py-0.5 text-[11.5px] font-bold text-slate-700 dark:text-slate-300 hover:text-slate-900 transition-colors cursor-pointer whitespace-nowrap"
                      ...
                      <Button
                        ...
                        onClick={handleDownloadDocx}
                        disabled={isDownloadingDocx}
                        className="h-8.5 px-3.5 rounded-lg border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 bg-white dark:bg-slate-800 hover:bg-slate-50 text-slate-700 dark:text-slate-200 text-[12px] font-bold cursor-pointer whitespace-nowrap shrink-0 flex items-center gap-1.5"
                      >
                        {isDownloadingDocx ? (
                          <>
                      ...
                      <Button
                        onClick={handlePrint}
                        className="h-8.5 px-4 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white shadow-xs text-[12px] font-bold cursor-pointer whitespace-nowrap shrink-0 flex items-center gap-1.5"
                      >
