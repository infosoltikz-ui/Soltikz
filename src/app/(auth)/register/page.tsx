        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 gap-3 mb-6">
            <button 
              ...
              className="flex items-center justify-center gap-2.5 h-11 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition-colors font-bold text-slate-700 text-sm shadow-sm hover:shadow-md w-full"
            >
